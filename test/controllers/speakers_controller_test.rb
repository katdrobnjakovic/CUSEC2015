...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { name: @speaker.name, photo: @speaker.photo, talkDescription: @speaker.talkDescription }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { name: @speaker.name, photo: @speaker.photo, talkDescription: @speaker.talkDescription }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
